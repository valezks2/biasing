                ...
                {isOwnProfile && (
                  <div className="absolute top-2 right-2 flex gap-1 opacity-0 group-hover/card:opacity-100 transition-opacity duration-200 z-30">
                    <button
                      ...
                      className="p-2 bg-background text-foreground border border-border hover:bg-foreground hover:text-background transition-all text-[10px] font-bold cursor-pointer"
                    >
                      ✎
                    </button>
                    <button
                      onClick={() => setDeletingItem(item)}
                      className="p-2 bg-background text-red-500 border border-border hover:bg-red-500 hover:text-white transition-all text-[10px] font-bold cursor-pointer"
                    >
                      ✕
                    </button>
                  </div>
